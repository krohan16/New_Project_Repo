...
class update_client(View):
    ...
    def get(self,request,pk):
        ...
        return render(request,'update_client.html',{'data':data})
...
class client_details(View):
    ...
    def get(self,request,pk):
        ...
        print(projects)
        return render(request,'client_details.html',{'data':data,'projects':projects})
...
class add_project(View):
    ...
    def get(self,request,pk):
        ...
        print(users)
        return render(request,'add_project.html',{'form':form,'users':users,'id':id})
...
class dashboard(View):
    ...
    def get(self,request):
        ...
        return render(request,'dashboard.html',{'data':data,'user':user})
